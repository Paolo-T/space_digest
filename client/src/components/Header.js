...
function Header() {
    return (
        <header className="mx-auto text-center mb-8 md:mb-12 pt-12 md:pt-16">
            <h1 className="tracking-tight bg-teal-300">Space digest</h1>
            <h3 className="w-4/5 md:w-3/5 md:leading-tight mb-2 mx-auto">
            ...
            <span className="span text-xs md:text-base text-gray-600 mt-0 mb-8 md:mb-10">
